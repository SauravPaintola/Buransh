...
const testimonials = [
  {
    ...
    <b class='text-base'>I urge everyone to reconnect with their roots and embrace the beauty of where we come from—it’s a story worth sharing, and a legacy worth preserving.</b>"`,
    name: "Riya",
  ...
  },
  {
    ...
    <span class='text-base'>हमारे समाज में कई लोग अभावग्रस्त हैं, जरूरतमंद हैं। इसके साथ ही कई प्रकार की व्याधियां समाज में फैली हुई है जिनके प्रति समाज को जागरूक करने की आवश्यकता है। मुझे विश्वास है कि संस्था के माध्यम से हम एक टीम गठित करते हुए निस्वार्थ भाव से समाज की सेवा करने में सफल होंगे।</span><br/><br/>
    <b class='text-base'>मैं युवा पीढ़ी से अपील करना चाहती हूं कि आप हमारी इस संस्था से जुडें और समाज को एक दिशा देने में अपनी महत्वपूर्ण भूमिका का निर्वहन करें। हार्दिक धन्यवाद।</b>"`,
    name: "Renu Ji",
    designation: "Volunteer",
    image: "https://via.placeholder.com/150",
  },
  {
    message: `"<span class='text-xl'>Buransh Foundation helps people by using all their resources to make small and effective changes. The foundation is working for Uttarakhand’s culture, education, health, and environment preservation, providing better opportunities to women and children and bringing positive change in society.</span><br/><br/>
    ...
    <b class='text-base'>I want to appeal to everyone through this Foundation that you all should support us in enriching and strengthening the culture of Uttarakhand and in environmental protection, student welfare, and women empowerment. Make your contribution.</b>"`,
    name: "Pooja Paintola",
    designation: "Volunteer",
    image: "https://via.placeholder.com/150",
  },
  {
    ...
    <span class='text-base'>I’ve experienced the challenges firsthand—studying in a village with limited resources and opportunities. When I moved to the city, I realized how important the right support is, but I also saw how easily our traditional values are forgotten in the rush for progress.</span><br/><br/>
    <b class='text-base'>A single person can bring perspective, but a large population can bring an actual change. We need your help. Please connect with us and become a part of us. Become a part of our beautiful state.</b>"`,
  ...
  },
  {
    ...
    <span class='text-base'>जब बुरांश फाउंडेशन का विचार सामने आया और इसके संस्थापक गिरीश चंद्र पैंतौला जी के विजन को साकार करने का अवसर मिला, तो मैंने इसे खुशी और गर्व के साथ स्वीकार किया। यह मेरे लिए अपने राज्य के लिए कुछ बड़ा और सकारात्मक करने का सुनहरा मौका था।</span><br/><br/>
    <span class='text-lg'>बुरांश फाउंडेशन अब मेरे लिए एक ऐसा मंच है, जिसके जरिए मैं उत्तराखंड को हर तरह से समृद्ध और मजबूत बनाने का सपना देखता हूं। हमारी परंपराएं, शिक्षा, पर्यावरण, और लोगों का सशक्तिकरण—इन सभी को साथ लेकर हमें एक उज्ज्वल भविष्य की ओर बढ़ना है। मैं चाहता हूं कि हर व्यक्ति, खासकर युवा पीढ़ी, इस बदलाव का हिस्सा बने और अपने राज्य की ताकत को पहचाने।</span><br/><br/>
    <b class='text-base'>आपका सहयोग जरूरी है
...
const TestimonialPage = () => {
  return (
    <div className="min-h-screen w-full  lg:mt-0">
      <Carousel
        autoplay
        autoplayDelay={5000} // Slide changes every 5 seconds
        loop // Carousel loops back to the first slide after the last
        className="w-full h-full "
      >
        {testimonials.map((testimonial, index) => (
          <div
            key={index}
            className="w-full h-screen flex flex-col items-center justify-center gap-8 mt-96 lg:mt-0 "
          >
            <h1
              className="text-4xl text-gray-600 leading- text-center w-4/5"
